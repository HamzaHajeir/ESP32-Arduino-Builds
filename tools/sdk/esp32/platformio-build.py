...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "lwip", "lwip", "src", "apps", "altcp_tls"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "cbor2", "port", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "rmaker_common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_diagnostics", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__cbor", "port", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_diag_data_store", "src", "rtc_store"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_diag_data_store", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_insights", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "rtc_store", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "json_parser", "upstream", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "json_parser", "upstream"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "json_generator", "upstream"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_schedule", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_secure_cert_mgr", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_rainmaker", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "gpio_button", "button", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "qrcode", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "ws2812_led"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_littlefs", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-dl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-dl", "include", "tool"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-dl", "include", "typedef"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-sr", "src", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-sr", "esp-tts", "esp_tts_chinese", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-sr", "include", "esp32"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp32-camera", "driver", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp32-camera", "conversions", "include"),
